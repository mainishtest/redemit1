  ...
  return (
    <section className="section-spacing section-padding">
      <div className="section-container">
        ...
        <div className="mt-16 grid gap-px bg-surface-300/40 rounded-xl overflow-hidden sm:grid-cols-2">
          {SERVICES.map((service, i) => {
            ...
            return (
              <Link
                ...
                className="group bg-surface-50 p-8 md:p-10 transition-all duration-300 hover:bg-surface-100"
              >
                {/* Service illustration */}
                {Visual && (
                  <div className="mb-6 -mx-2 -mt-2">
                    <Visual className="w-full h-auto max-h-[140px] opacity-60 group-hover:opacity-80 transition-opacity duration-300" />
                  </div>
                )}

                <div className="flex items-center gap-3 mb-5">
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-surface-200 text-txt-muted group-hover:text-txt-secondary transition-colors">
                ...
                <h3 className="text-heading-sm text-txt-primary group-hover:text-txt-primary transition-colors">
                  {service.title}
                </h3>
                ...
                <span className="mt-5 inline-flex items-center gap-1.5 text-body-sm font-medium text-txt-muted group-hover:text-brand-400 transition-colors duration-300">
                  Learn more
