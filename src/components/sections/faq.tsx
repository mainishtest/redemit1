          ...
          <div className="lg:col-span-3">
            <div className="space-y-0">
              {FAQ_ITEMS.map((item, i) => (
                <div key={i} className="border-b border-surface-300/40">
                  <button
                  ...
                  >
                    <span className={cn(
                      ...
                      openIndex === i ? 'text-txt-primary' : 'text-txt-secondary group-hover:text-txt-primary'
                    )}>
                      {item.question}
                    </span>
                    <span className={cn(
                      ...
                      openIndex === i
                        ? 'border-brand-400/30 text-brand-400 bg-brand-400/5'
                        : 'border-surface-400 text-txt-faint'
                    )}>
                      {openIndex === i
                  ...
                  >
                    <p className="text-body text-txt-secondary leading-relaxed pr-12">
                      {item.answer}
                    </p>
                  </div>
                </div>
